# 🚀 Mutsa-Rocketdan (멋사 로켓단)
### "강의 소스에서 지능형 학습 경로를 추출하는 AI 학습 보조 플랫폼"

멋사 로켓단은 방대한 강의 자료(STT 스크립트)와 커리큘럼 데이터를 기반으로, 학습자에게 최적화된 **맞춤형 퀴즈**와 **지능형 학습 가이드**를 자동으로 생성하는 엔드투엔드 솔루션을 구축합니다.

<div align="center">
  <h3>🎬 서비스 시연 영상</h3>
  <video src="assets/demo_video.mp4" width="800" controls muted autoplay loop></video>
</div>
